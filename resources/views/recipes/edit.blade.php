...
<body>
    <!-- ヘッダー -->
    <div class="header">
        <a href="{{ route('recipes.show', $recipe->id) }}" class="back-link">← 詳細に戻る</a>
                ...
                <div class="tag-section">
                    ...
                    <div id="allTags" class="tag-list">
                        ...
                        <label class="tag-checkbox">
                            <input type="checkbox" value="{{ $tag->id }}" data-name="{{ $tag->name }}" data-color="{{ $tag->color ?? '#e0e0e0' }}" {{ $recipe->tags->contains($tag->id) ? 'checked' : '' }}>
